...
# # Не работающий резерв основного кода.
#
...
def get_data(city_name):
    ...
    # Эмуляция браузера для игнорирования спама запроса
    headers = {
    ...
    # Полный XPath для поиска значений температуры
    ...
    if temp_element:
        return {
            'temp_city': f"{temp_city[0].text}",
            'temp_value': f"Температура: {temp_element[0].text}°C",
